            ...
            <nav className="navbar navbar-expand-lg" 
                ...
                <div className="container-fluid" style={{ display: 'flex', alignItems: 'center' }}>
                    <Link className="navbar-brand" to="/home" style={{ marginLeft: '2rem' }}>
                        <img src="./src/assets/component/About/final logo.jpg" alt="Logo"
                             style={{
                                 height: '53px',
                                 width: '53px',
                                 borderRadius: '50%',
                    ...
                    <div className="collapse navbar-collapse" id="navbarScroll" style={{ marginLeft: 'auto' }}>
                        <ul className="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll" style={{ marginRight: '2rem' }}>
                            <li className="nav-item" style={{ marginRight: '1.9rem', fontFamily: 'Verdana, Geneva, Tahoma, sans-serif', fontWeight: 'bold', fontSize: 'medium' }}>
